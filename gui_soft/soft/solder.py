...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(706, 340)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("image/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        Dialog.setWindowIcon(icon)
        Dialog.setStyleSheet("background-image: url(\"/workspace/solder/gui_soft/soft/image/background.png\"); \n"
"background-repeat: no-repeat; \n"
"background-position: center")
        self.tabWidget = QtWidgets.QTabWidget(Dialog)
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 681, 321))
        self.tabWidget.setStyleSheet("selection-color: rgb(164, 0, 0);")
...
"}")
        ...
        self.set_temp_slider.setTickPosition(QtWidgets.QSlider.TicksBothSides)
...
"")
        ...
        self.comboBox.setGeometry(QtCore.QRect(10, 20, 141, 25))
...
"")
        ...
        self.pushButton.setGeometry(QtCore.QRect(160, 20, 71, 25))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(370, 10, 301, 261))
        self.groupBox_3.setObjectName("groupBox_3")
        self.layoutWidget = QtWidgets.QWidget(self.groupBox_3)
        self.layoutWidget.setGeometry(QtCore.QRect(10, 20, 291, 181))
        ...
        self.pid_p_splitter = QtWidgets.QSplitter(self.splitter_4)
...
"")
        ...
        self.pid_i_splitter = QtWidgets.QSplitter(self.splitter_4)
...
"")
        ...
        self.pid_d_splitter = QtWidgets.QSplitter(self.splitter_4)
...
"")
        ...
        self.pid_write_settings_btn.setGeometry(QtCore.QRect(10, 210, 111, 31))
